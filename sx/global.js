...
window.toast = {
    show(message, type = 'info', title = null) {
        ...
        iconDiv.innerHTML = icons[type] || icons.info; // Icons are static trusted strings
        ...
        closeBtn.innerHTML = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>'; // Static SVG
